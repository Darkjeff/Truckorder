...
/**
 * \file    test/phpunit/TruckOrderFunctionalTest.php
 * \ingroup truckorder
...
/**
 * Class TruckOrderFunctionalTest
 *
 ...
 *
 * @package Testtruckorder
 */
class TruckOrderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTruckOrder')->click();
		} else {
			// Disable the module
			$this->byHref('modTruckOrder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/truckorder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('truckorder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/truckorder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('truckorder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('truckorderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTruckOrder_TruckOrderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTruckOrder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
