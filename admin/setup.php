...
/**
 * \file    truckorder/admin/setup.php
 * \ingroup truckorder
 * \brief   TruckOrder setup page.
 */
...
// Translations
$langs->loadLangs(array("admin", "truckorder@truckorder"));
...
print dol_get_fiche_head($head, 'settings', '', -1, "truckorder@truckorder");
